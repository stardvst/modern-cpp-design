...
template <typename Singleton, template <class> class CreationPolicy = CreateUsingNew,
  template <class> class LifetimePolicy = DefaultLifetime, template <class> class ThreadingModel = SingleThreaded>
...
template <typename S, template <class> class C, template <class> class L, template <class> class T>
...
template <typename S, template <class> class CreationPolicy, template <class> class LifetimePolicy, template <class> class ThreadingModel>
...
template <typename S, template <class> class CreationPolicy, template <class> class L, template <class> class T>
